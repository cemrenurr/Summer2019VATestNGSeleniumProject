package com.cybertek.tests.d_17_extent_reports;
...
/*HTML REPORTING
        ...
        1- Re-creation steps with expected and actual
        2-screenshot
...
//    ExtentHtmlReporter htmlReporter;        // used to create the HTML report file
//    ExtentTest extentLogger;                // this will define a test, enables adding logs, authors, testInfo etc.
//                                            //this one remembers all configurations done before it.
//
